...
| `model_slice_pdg_v11.pt` | §32 | Juliet pretrain (with atoi sinks) + Devign RankNet FT; correct eval preprocessor | — |
...
| §32 | Juliet pretrain (atoi sinks) → Devign RankNet FT; correct preprocessor | — | TBD |
